...
interface DomainProviderBarProps {
  providers: Provider[];
  activeProvider: string | null;
  onProviderClick: (provider: string | null) => void;
}

const DomainProviderBar = ({ providers, activeProvider, onProviderClick }: DomainProviderBarProps) => {
...
export default DomainProviderBar;
