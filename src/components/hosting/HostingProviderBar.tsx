...
interface HostingProviderBarProps {
  providers: Provider[];
  activeProvider: string | null;
  onProviderClick: (provider: string | null) => void;
}

const HostingProviderBar = ({ providers, activeProvider, onProviderClick }: HostingProviderBarProps) => {
...
export default HostingProviderBar;
