...
interface DedicatedProviderBarProps {
  providers: Provider[];
  activeProvider: string | null;
  onProviderClick: (provider: string | null) => void;
}

const DedicatedProviderBar = ({ providers, activeProvider, onProviderClick }: DedicatedProviderBarProps) => {
...
export default DedicatedProviderBar;
