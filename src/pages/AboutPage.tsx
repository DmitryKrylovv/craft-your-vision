...
const ecosystem = [
  { name: 'Plooza Кошелёк', desc: 'Единый биллинг для оплаты услуг у разных провайдеров одним кликом', link: '/pay' },
  { name: 'Plooza Работа', desc: 'Платформа вакансий и специалистов в сфере IT-инфраструктуры', link: '/apps' },
  { name: 'Plooza Инженеры', desc: 'Удалённые руки в дата-центрах по всему миру — 24/7 поддержка', link: '/smart-hands' },
  { name: 'Plooza Защита', desc: 'Сервис синхронизации блокировок и защиты от злоумышленников', link: '/anti-abuse' },
  { name: 'Plooza Реселлер', desc: 'White-label маркетплейс хостинга под вашим брендом для партнёров', link: '/reseller' },
  { name: 'Plooza Браузер', desc: 'Безопасный браузер для удобного управления инфраструктурой', link: '/migration' },
];
